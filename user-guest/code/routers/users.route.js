    ...
    LocalUser.findOne({
      ...
      if (user) {
        ...
        const clientID =
          ...
          "1055137412529-mkd26glq6l0glta4h2qf2i4ct6p4ekei.apps.googleusercontent.com";
        const clientSecret = "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"; /*"NAjZvQbzYipjQYBxnaHPHSr9";*/
        const redirectUri = "https://developers.google.com/oauthplayground";
        const refreshToken =
          // "1//04pUalhF17quECgYIARAAGAQSNwF-L9IrtIab8o_JgFJXXg0bnTvA6q_3ODGZ2CxpgzTw2uMFQysLTh_YgX5PY4TWCszQ3ZVENzQ";
             "1//04C6BlmXa5TOICgYIARAAGAQSNwF-L9IrTPDMUMaeIQ5pgj3U_R4uCaw6kRSbSr3jC7mt2Zs9UjOoPiMLi_GQ7BiZL32Osa6BDQA";
        ...
        const mailOption = {
          from: "WEB Courses <languyen16000@gmail.com>",
          to: email,
          subject: "Authenticte message",
          text: "Hello form WEB Courses",
